...
export const PRODUCTOS_INICIALES: Producto[] = [
  ...
  { id: 3, nombre: "Kit Pesas Eco", precio: 45.99, categoria: "deportes", stock: 8, imagen: "https://picsum.photos/200?random=3", descripcion: "Caucho reciclado de alta durabilidad." },
  { id: 4, nombre: "Lámpara LED", precio: 25.00, categoria: "hogar", stock: 5, imagen: "https://picsum.photos/200?random=4", descripcion: "Iluminación cálida y sostenible." },
  { id: 5, nombre: "Teclado Bambú", precio: 65.00, categoria: "tecnología", stock: 12, imagen: "https://picsum.photos/200?random=5", descripcion: "Diseño ergonómico en madera de nogal." },
  ...
  { id: 10, nombre: "Mouse Inalám.", precio: 22.00, categoria: "tecnología", stock: 0, imagen: "https://picsum.photos/200?random=10", descripcion: "Plásticos rescatados del océano." },
  ...
  { id: 12, nombre: "Cuerda Saltar", precio: 12.00, categoria: "deportes", stock: 15, imagen: "https://picsum.photos/200?random=12", descripcion: "Fibras de cáñamo natural." }
];